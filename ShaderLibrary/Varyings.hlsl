...
Varyings BuildVaryings(Attributes input)
{
    ...
    // Do vertex modification in camera relative space (if enabled)
        ...
        #endif
        #if _CUSTOMSHADOWBIAS
            output.positionCS = TransformWorldToHClip(ApplyShadowBias_CustomBias(positionWS, normalWS, lightDirectionWS, vertexDescription.ShadowDepthBias, vertexDescription.ShadowNormalBias));
        #else
